...
//        
//
//        fileUpload.setFileByte(Files.readAllBytes(new File("/home/apprentice/Work/week-10-12/chris-david-greg-ollie-ft-ka-10-12/CapstoneCMS/src/main/webapp/img/wreath.jpg").toPath()));
//
//        fileUpload.setExtensionType("image/jpeg");
//        fileUpload.setFileName("Wreath");
