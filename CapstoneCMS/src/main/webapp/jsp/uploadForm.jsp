                ...
                <div class="col-md-8">
                    <div class="fileinput fileinput-new">
                        ...
                        <p>
                            ...
                            <textarea class="form-control tmce" id="postEditContent"></textarea>
                            <textarea class="form-control tmce" id="pageAddContent"></textarea>
                            <textarea class="form-control tmce" id="pageEditContent"></textarea>
                            <textarea class="form-control tmce" id="postAddContent"></textarea>
